...
public class UnderlinePageIndicator extends View implements PageIndicator {
    ...
    public UnderlinePageIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        mBottomLineColor = a.getColor(R.styleable.UnderlinePageIndicator_bottom_line_color, Color.parseColor("#ffffff"));
        setFades(a.getBoolean(R.styleable.UnderlinePageIndicator_fades, defaultFades));
        setSelectedColor(a.getColor(R.styleable.UnderlinePageIndicator_selectedColor, defaultSelectedColor));
        setFadeDelay(a.getInteger(R.styleable.UnderlinePageIndicator_fadeDelay, defaultFadeDelay));
        setFadeLength((int) a.getDimension(R.styleable.UnderlinePageIndicator_fadeLength, 1000));
        setLength((int) a.getDimension(R.styleable.UnderlinePageIndicator_vpi_length,0));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawRect(0, bottom- Tools.dip2px(1), getWidth(), bottom, mPaint);
        mPaint.setColor(mSelectColor);
        float w = 0;
        if(mLineWidth != 0) w = (right - left - mLineWidth) / 2f;
        canvas.drawRect(left + w, top, right - w, bottom, mPaint);
    }
